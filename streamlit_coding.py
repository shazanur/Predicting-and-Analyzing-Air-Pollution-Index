...
if menu == "Model Development":
    st.subheader("⚙️ Model Development & Hyperparameter Tuning")
...
if menu == "Model Evaluation and Comparison":
    ...
    # --------------------------------------------------
    st.markdown("### 🔄 Model Performance Progress")
...
if menu == "Best Model & Prediction":
    ...
    with col2:
        ...
        normalized_conc = st.slider(
            "🫁 Normalised Pollution Concentration",
